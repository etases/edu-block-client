        ...
        entries: (recordData as DataInterface).entries
          .map(
            ({
              ...
              finalScore: Number(Number(finalScore).toFixed(2)),
              firstHalfScore: Number(Number(firstHalfScore).toFixed(2)),
              secondHalfScore: Number(Number(secondHalfScore).toFixed(2)),
              requestDate,
              subjectId,
